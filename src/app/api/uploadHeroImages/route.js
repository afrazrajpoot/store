  ...
  try {
    ...
    if (existingHeroImages) {
      ...
      return NextResponse.json(
        { message: 'Hero images updated successfully', heroImages: existingHeroImages },
        { status: 200 }
      );
    } else {
      ...
      return NextResponse.json(
        { message: 'Hero images uploaded successfully', heroImages: newHeroImages },
        { status: 201 }
      );
    }
  } catch (error) {
...
export async function GET(request) {
  try {
    ...
    if (existingHeroImages) {
      ...
      return NextResponse.json({ error: 'Hero images not found' }, { status: 404 });
    }
  } catch (error) {
