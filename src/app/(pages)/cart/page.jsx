      ...
      <main className="flex-grow container mx-auto px-4 mt-[8vw] py-8">
        {cartItems.length === 0 ? (
          <div className="text-center py-32 bg-white rounded-2xl shadow-sm">
            ...
            <p className="text-gray-600 text-lg mb-6">Your shopping cart is empty</p>
            <button
              onClick={() => router.push('/')}
                    ...
                    <div className="flex-grow space-y-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-600">
                        ...
                        <div className="flex items-center">
                          <span className="w-3 h-3 rounded-full mr-1" style={{ backgroundColor: item.color.toLowerCase() }} />
                          {item.color}
                        </div>
                      </div>
                    </div>
      ...
      <footer className="bg-white border-t mt-auto">
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">© 2024 Your Store. All rights reserved.</p>
