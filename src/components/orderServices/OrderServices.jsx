...
export const OrderActions = ({ order, handleComplete, handleRTO, isCompleting }) => (
            ...
            <div className="p-6 bg-gray-50">
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-2xl font-bold">₹{selectedOrder.totalPrice.toLocaleString()}</p>
                    </div>
                </div>
            </div>
        </motion.div>
...
export const PaginationControls = ({ pagination, currentPage, handlePageChange }) => (
